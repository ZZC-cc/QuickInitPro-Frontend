export default {
  ...
  'account.settings.form-username': '用户名',
  'account.settings.form-description': '个人简介',
  'account.settings.form-avatar': '头像',
  'account.settings.form-password': '密码',
  'account.settings.form-confirmPassword': '确认密码',
  'account.settings.form-sex-male': '男',
  'account.settings.form-sex-female': '女',
  'account.settings.form-mobile': '手机号',
  ...
  'account.settings.form-rule-avatar': '请上传头像',
  'account.settings.form-rule-username': '请输入用户名',
  'account.settings.form-rule-phoneNumber': '请输入联系电话',
  'account.settings.form-rule-address': '请输入街道地址',
  'account.settings.form-rule-mobile': '请输入手机号',
  'account.settings.form-rule-password': '请输入密码',
  'account.settings.form-rule-confirmPassword': '请输入确认密码!',
  'account.settings.form-rule-region': '请选择',
  'account.settings.form-rule-sex': '请选择',
  'account.settings.form-sex': '性别',
  'account.settings.form-rule-sex-male': '男',
  'account.settings.form-rule-sex-female': '女',
  'account.settings.form-rule-sex-secret': '保密',
  'account.settings.form-rule-email': '请输入邮箱地址',
  'account.settings.form-rule-description': '请输入个人简介',
  ...
  'account.settings.security.account-password-desc': '当前密码强度: 中等',
